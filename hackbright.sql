...
--
-- Name: grades_grades_id_seq; Type: SEQUENCE; Schema: public; Owner: user
--
...
ALTER TABLE public.grades_grades_id_seq OWNER TO "user";

--
-- Name: grades_grades_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: user
--
...
--
-- Name: projects_projects_id_seq; Type: SEQUENCE; Schema: public; Owner: user
--
...
ALTER TABLE public.projects_projects_id_seq OWNER TO "user";

--
-- Name: projects_projects_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: user
--
...
--
-- Name: grades_id; Type: DEFAULT; Schema: public; Owner: user
--
...
--
-- Name: projects_id; Type: DEFAULT; Schema: public; Owner: user
--
...
--
-- Name: grades_grades_id_seq; Type: SEQUENCE SET; Schema: public; Owner: user
--
...
COPY public.projects (projects_id, title, description, max_grade) FROM stdin;
1	Markov	Tweets generated from Markov chains	50
2	Blockly	Game for navigating a maze	100
3	Ubermelons	Melons, melons, melons	150
4	Twitter API	Used Twitter API to create Twitter bot	20
\.


--
-- Name: projects_projects_id_seq; Type: SEQUENCE SET; Schema: public; Owner: user
--

SELECT pg_catalog.setval('public.projects_projects_id_seq', 4, true);
